...
const config = {
  ...
  url: 'https://physical-ai-humanoid-book.github.io',
  ...
  // TODO: T027 - Configure link and cross-reference validation here.
  // This might involve Docusaurus plugin configuration or external tooling integrated into the build process.
  // Refer to the project's final phase tasks for more details.
};

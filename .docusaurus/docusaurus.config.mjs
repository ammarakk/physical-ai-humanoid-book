...
export default {
    ...
    [
      "classic",
      {
        "docs": {
          ...
          "editUrl": "https://github.com/physical-ai-humanoid-book/physical-ai-humanoid-book/tree/main/"
        },
        "blog": {
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2025 Physical AI & Humanoid Robotics Book. Built with Docusaurus. AI technology explained."
    },
    "prism": {
      "theme": {
        "plain": {
